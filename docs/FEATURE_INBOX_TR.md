...
| F-024 | Elk-benzeri sade hedef ülke kur görünümü | in_progress | yüksek | M | Faz 3 | Frankfurter tabanlı gerçek kur provider + Travel workspace tek kur kartı (1 base = target) eklendi; UX polish ve offline fallback sırada. |
