...
| F-024 | Elk-benzeri sade hedef ülke kur görünümü | in_progress | yüksek | M | Faz 3 | Frankfurter provider + tek kur kartı + live/cached + offline fallback + dakika bazlı güncellik/stale göstergesi eklendi; UX polish sırada. |
