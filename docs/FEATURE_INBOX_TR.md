...
| F-012 | Not ve Journal için ayrı Template Studio | in_progress | yüksek | M | Faz 2 | Domain + template engine + AppKit TemplateStudio view/viewmodel eklendi; şablon düzenleme/önizleme katmanı sırada. |
...
| F-014 | Şablon/Not/Journal içine resim ekleme | in_progress | yüksek | M | Faz 2 | Attachment modeli + servis + testler eklendi; UI önizleme/düzenleme akışı sırada. |
