...
| F-007 | Şifreli günlük (journal) modu | in_progress | yüksek | M | Faz 2 | Journal workspace + app lock/passcode + encryption service + Keychain/LocalAuthentication adaptörleri eklendi; lock sırasında editor state privacy reset + locked editor placeholder + kayıtta "Encrypt On Save" seçeneği eklendi; production wiring ve decrypt UX polish sırada. |
