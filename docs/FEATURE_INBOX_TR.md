...
| F-013 | Zengin düzenleme barı (editor toolbar) | in_progress | yüksek | L | Faz 2-3 | Komut çekirdeği başlatıldı (girinti/çıkıntı, başlık, checklist, divider); UI toolbar katmanı sırada. |
